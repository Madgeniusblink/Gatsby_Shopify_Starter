    ...
    <>
      ...
      >
        ...
        <div className="level-right">
          <div >
            <button aria-label="open shopping cart" className="button" style={{ position: "relative", background: "transparent", border: "none"}} onClick={toggleCartOpen} >
              {
                qty > 0 &&
                  <div
                    style={{
